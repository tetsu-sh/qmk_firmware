...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
    // ,--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+-------------.
        KC_ESC  ,KC_1    ,KC_2    ,KC_3    ,KC_4    ,KANA    ,         KC_6    ,KC_7    ,KC_8    ,KC_9    ,KC_0    ,KC_MINS ,
    // |--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+-------------|
    ...
    // |--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+-------------|
        KC_TRNS ,KC_F1   ,KC_F2   ,KC_F3   ,KC_F4   ,KC_F5   ,         KC_F6   ,KC_F7   ,KC_F8   ,KC_F9    ,KC_F12 ,KC_TRNS ,
    // |--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+-------------|
        KC_TRNS ,KC_EXLM ,KC_AT   ,KC_HASH ,KC_DLR  ,KC_PERC ,         KC_CIRC ,KC_AMPR ,KC_ASTR ,KC_9    ,KC_0    ,KC_TC_INC ,
    // |--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+-------------|
        KC_TRNS ,KC_TRNS ,KC_TRNS ,KC_TRNS ,KC_TRNS ,KC_TRNS ,         KC_SD_H ,KC_LBRC, KC_RBRC ,KC_LT   ,KC_GT   ,KC_TC_DEC ,
    // |--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+-------------|
    ...
    // |--------+--------+--------+--------+--------+--------|        |--------+--------+--------+--------+--------+-------------|
        KC_ESC  ,KC_Q    ,KC_W    ,KC_E    ,KC_R    ,KC_T    ,         KC_MY_BTN5,KC_U    ,KC_I    ,KC_O    ,KC_P    ,KC_BSPC ,
    // |--------+--------+--------+--------+--------+--------|        |----------+----------+----------+----------+----------+-------------|
        KC_TAB  ,KC_A  ,KC_MY_BTN2,KC_MY_SCR,KC_MY_BTN1,KC_G ,         KC_MY_BTN4,KC_MY_BTN1 ,KC_MY_SCR,KC_MY_BTN2 ,KC_SCLN  ,KC_ENT ,
    // |--------+--------+--------+--------+-----------------|        |----------+----------+----------+----------+----------+-------------|
        KC_RSFT ,KC_Z    ,KC_X    ,KC_C    ,KC_V    ,KC_B    ,         KC_N      ,KC_M       ,KC_COMM  ,KC_DOT   ,KC_SLSH  ,BALL,
    // |--------+--------+--------+--------+--------+--------|        |----------+----------+----------+----------+----------+-------------|
